...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Obtener aderezos y dips de la base de datos
        ...
        foreach ($createdProducts as $productModel) {
            ...
            // Variantes de Tipo de Medallón (Carne $0, Veggie Tomate Seco $15.500, Veggie Zanahoria $15.500)
            ...
            // Opciones Cuádruple y Quintuple
            ProductVariant::create([
                'product_id' => $productModel->id,
                'name' => 'Tipo de Medallón',
                'value' => 'Cuádruple',
            ...
            // Crear opciones de aderezos desde la base de datos
            ...
            // Crear opciones de dips desde la base de datos
            foreach ($dips as $dip) {
                ProductOption::create([
                    'product_id' => $productModel->id,
                    'name' => 'Dips',
