        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div class="lg:col-span-3" id="checkoutFormCol">
                <form id="checkoutForm" class="space-y-8">
                    ...
                    <section class="card p-6" id="deliveryMethodSection" style="max-width:540px;margin:0 auto;">
                        <div class="d-flex align-items-center justify-content-between" id="deliveryMethodHeader" style="cursor:pointer;" onclick="toggleDeliveryMethodSection()">
                    ...
                    <section id="deliverySection" class="card p-6 hidden">
                        <h2 class="text-lg font-display text-text-primary mb-4">Dirección de Entrega</h2>
                        <div class="space-y-4">
                            @auth
                    ...
                    @if (!$businessSettings['skip_turno_selection'])
                        <!-- Delivery Scheduling -->
                        <!-- Selected Turn Display -->
                        <section class="card p-6">
                            <h2 class="text-lg font-display text-text-primary mb-4">Entrega Seleccionada</h2>
                            <div id="selectedTurnDisplay" class="bg-primary-50 border border-primary-200 rounded-lg p-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h3 class="font-medium text-primary">Horario de Entrega</h3>
                                        <p id="selectedTurnTime" class="text-sm text-primary-700">Cargando...</p>
                                    </div>
                                    <a href="{{ route('turnos') }}"
                    ...
                    <!-- Payment Method -->
                    <section class="card p-6">
                        <h2 class="text-lg font-display text-text-primary mb-4">Método de Pago</h2>
                        <div class="space-y-3">
                            @php
                                // payment_methods ya viene decodificado como array desde AppServiceProvider
                                $paymentMethods = $businessSettings['payment_methods'] ?? null;

                                // Si es null, no es array, o está vacío, usar valores por defecto
                                ...
                                $availableMethods = [
                                    ...
                                    'transfer' => [
                                        ...
                                        'color' => 'text-accent',
                                        'description' => 'Mercado Pago, Ualá, Brubank',
                                    ],
                                ];
                                $firstEnabled = true;
                            @endphp
                                ...
                                @if (in_array($methodKey, $paymentMethods))
                                    <label
                                        ...
                                        <div class="ml-3 flex items-center space-x-3">
                                            <i class="{{ $methodData['icon'] }} {{ $methodData['color'] }} text-lg"></i>
                                            <div>
                                                <div class="font-medium text-text-primary">{{ $methodData['name'] }}</div>
                                                <div class="text-sm text-text-secondary">{{ $methodData['description'] }}
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                    ...
                    <section class="card p-6">
                        ...
                        <div id="couponContainer">
                            <div id="couponInputSection">
                                <div class="mb-3">
                                    <label class="block text-sm font-medium text-text-primary mb-2">Ingresalo acá y obtené tu descuento</label>
                                    <div id="otpContainer" class="d-flex justify-content-center gap-2 mb-3">
                                        <!-- Slots OTP se generarán dinámicamente aquí -->
                                    </div>
                                ...
                                <button 
                                    type="button" 
                                    id="applyCouponBtn"
                                    class="w-full px-6 py-3 rounded-lg font-semibold text-white transition-all duration-300"
                            ...
                            <div id="couponAppliedSection" class="hidden mt-4">
                                <div class="bg-success bg-opacity-10 border-2 border-success rounded-lg p-4 animate-slide-in">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="w-12 h-12 bg-success rounded-circle d-flex align-items-center justify-content-center">
                                                <i class="fas fa-check text-white fs-5"></i>
                                            </div>
                                            <div>
                                                <div class="fw-semibold text-success" id="couponName"></div>
                                                <div class="text-sm text-success" id="couponDiscount"></div>
                                            </div>
                                        </div>
                                        <button 
                                            type="button" 
                    ...
                    <section class="card acompanamientos-card p-6">
                        <h2 class="text-2xl font-display text-text-primary mb-1">Estás a tiempo de agregar a tu pedido:</h2>
                        ...
                        <div class="mt-3 flex gap-2">
                            <button type="button" id="addSelectedAcompanamientos" class="flex-1 btn-primary text-white text-sm py-2 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hidden" disabled>
                ...
                <div class="sticky top-24">
                    <div class="card p-6">
                        ...
                        <button type="submit" form="checkoutForm" id="placeOrderBtn"
                            ...
                            onmouseover="this.style.backgroundColor='#20BA5A'; this.style.transform='translateY(-2px)'; this.style.boxShadow='0 8px 25px rgba(37, 211, 102, 0.3)';"
    ...
    <script>
        ...
        async function loadSelectedTurn() {
            ...
            if (selectedMicroturno) {
                ...
                // Load turn details
                loadTurnDetails(selectedMicroturno);
            } else {
                // No turn selected, redirect to turnos page
                window.location.href = '{{ route('turnos') }}';
            }
        }
